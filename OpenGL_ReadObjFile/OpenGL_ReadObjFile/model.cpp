...
//显示模型数据
void Objmodel::showObj(GLint mode1,GLint mode2, GLfloat* _color) {
...
//        std::cout << face_vertex[i][0] - 1 << ", "<< face_vertex[i][1] -1 << ", " << face_vertex[i][2] - 1<<"\n";
//        std::cout << vertex[face_vertex[i][0] - 1][0] << ","<<vertex[face_vertex[i][0] - 1][1]<<"," << vertex[face_vertex[i][0] - 1][2] << "\n";
//        std::cout << vertex[face_vertex[i][1] - 1][0] << ","<<vertex[face_vertex[i][1] - 1][1]<<"," << vertex[face_vertex[i][1] - 1][2] << "\n";
//        std::cout << vertex[face_vertex[i][2] - 1][0] << ","<<vertex[face_vertex[i][2] - 1][1]<<"," << vertex[face_vertex[i][2] - 1][2] << "\n";
...
//    x_max /= 10; y_max /= 10; z_max /= 10;
    ...
    for (int i = 0; i < v_num; i++) {     //这是单独去最大值与最小值来得出包围盒
        if (x_max < vertex[i][0])
            x_max = vertex[i][0];
        if (x_min > vertex[i][0])
            x_min = vertex[i][0];
    ...
    std::cout<< "center coordinate : (" << x_center << ", " << y_center << ", " << z_center << ")\n";
    std::cout<< "minimun coordinate : (" << x_min << ", " << y_min << ", " << z_min << ")\n";
    std::cout<< "maximun coordinate : (" << x_max << ", " << y_max << ", " << z_max << ")\n";
    return center;
